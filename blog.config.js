...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '出海101', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '这边风景独好', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://crossborder101.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '出海, 跨境, 电商, 众筹', // 网站关键词 英文逗号隔开
